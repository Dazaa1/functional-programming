def convert_file_format(filename, target_format):
    """Converts a file to a target format if the conversion is valid.
    Args:
        filename: The name of the file to convert.
        target_format: The desired format to convert the file to.
    Returns:
        The new filename with the target format if conversion is valid, else None.
    """
